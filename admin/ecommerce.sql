...
CREATE TABLE `pesanan` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nama_produk` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `produk` (
  `id` int NOT NULL AUTO_INCREMENT,
  `kode` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nama` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `harga` double NOT NULL,
  `stok` int NOT NULL,
  `jenis_produk` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-10 14:42:52
